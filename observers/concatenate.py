...
class ArrayConcatenateObserver(AbstractObserver):
    def __init__(self, sub_observers : list[AbstractObserver], axis = 0, **kwargs) -> None:
    ...
    def observation_space(self) -> Space:
        ...
        for sub_observer in self.sub_observers:
            sub_space : Dict = sub_observer.observation_space()
            spaces.update(sub_observer.observation_space().spaces)
